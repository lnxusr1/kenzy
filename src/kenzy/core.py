...
class KenzyHTTPServer(HTTPServer):
    ...
    def __init__(self, server_address, RequestHandlerClass, bind_and_activate: bool = True, config_file=None, settings={}) -> None:
        ...
        try:
            if config_file is not None:
                #save_settings(config_file, self.settings)
                pass

        except Exception as e:
            self.logger.warning(f"Error saving configuration: {str(e)}")
